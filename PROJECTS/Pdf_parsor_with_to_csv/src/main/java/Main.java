...
//        PASSWORD OF  N - DIFFERENT NSDL PDFS
        String[] password = {"PASS1","PASS2","PASS3"};
        for(int i=1;i<=3;i++){


//           opne file with proper path
//            FILE PATH WHERE YOUR NSDL - PDF IS LOCATED
            File file = new File("D:\\DIR\\DIR\\src\\main\\resources\\SAMPLE"+i+".pdf");
...
//            goal path where the csv geberated
            String path = "C:\\Users\\USER_NAME\\OneDrive\\Desktop\\"+date_formate+i+"\\";
